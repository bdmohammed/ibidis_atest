...
const ProfilePicModal = ({show, profilePic,cancel,clickNext}: any) => {
    console.log(profilePic,"profilePic",API_UPLOAD_URL)
  return (
    ...
    animationInTiming={600}>
      ...
      {clickNext ? <TouchableOpacity
          ...
          onPress={() => clickNext()}>
          <Text style={[styles.backTextWhite, {fontSize: 16}]}>Update</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => cancel()}>
          <Text style={[styles.backTextWhite, {fontSize: 16}]}>Close</Text>
        </TouchableOpacity>
    </Modal>
  );
};
...
export default React.memo(ProfilePicModal);

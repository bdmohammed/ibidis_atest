export default {
  ...
  PROFILE: 'PROFILE',
  POST_NEW_ADD: 'Post New Ad',
  FILTER_POST: 'Filter Post',
  ITEM_NAME: 'Item name',
  SEND_MAIL: 'Send Email',
  BID_ALIAS_NAME: 'Bid Alias Name',
  DOB: 'Select DOB',
  USER_NAME: 'User Name',
  MY_ADS: 'My Ads',
  ADS: 'Ads',
  ...
  PASSWORD_NOT_MATCH: 'Password and Confirm Password did not matched',
  MESSAGE: 'Message',
...
Amount`,
  ...
  ENTER_BID_PRICE: 'Enter bid amount',
  ...
  FAWRY_DESC_COMPLTE_PAYMENT:
    'Please open & complete the payment in your Fawry Banking App within',
  YOUR_ORDER_ID: 'Your order ID',
  ORDER_AMOUNT: 'Order Amount',
  DO_NOT_PRESS_UNTIL: 'Do not press back button until the payment is complete.',
  FAILED: 'Payment failed!',
  YOUR_PAYMENT_FAILED: 'Your order payment has been submitted!',
};
